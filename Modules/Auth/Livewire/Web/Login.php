...
class Login extends Component
{
    ...
    public function login(): void
    {
        try {
            ...
            $this->redirectIntended(
                default: RouteServiceProvider::USER_DASHBOARD,
                navigate: true
            );
        } catch (\Exception $e) {
            $this->notifyError($e);
    ...
    /**
     * Ensure the user is not locked out due to too many failed attempts.
     *
     * @return void
     *
     * @throws \Illuminate\Validation\ValidationException
    ...
    /**
     * Generate a unique key for throttling based on email and IP.
     *
     * @return string
     */
    ...
    {
        return view('auth::livewire.web.login', [
            'x' => 'Lorrem'
        ]);
    }
}
