<div class="container bg-white py-20">
    <div class="flex flex-col items-start gap-3 pb-20 md:flex-row">
        <div class="md:w-1/3">
            <p class="mb-2 flex items-center gap-2 text-sm font-semibold uppercase tracking-wide text-blue-600">
                <span class="inline-block h-0.5 w-6 bg-blue-600"></span>
                        ...
                        <div class="overflow-hidden rounded-xl bg-white shadow-md ring-2 ring-gray-200">
                            <div class="aspect-square relative w-full">
                                ...
                                <div class="absolute inset-0">
                                    <div
                                         class="absolute -right-10 -top-10 z-0 h-40 w-40 rounded-full bg-blue-200 opacity-30 blur-2xl">
                                    </div>
                                    <div
                                         class="w-50 h-50 absolute -bottom-10 -left-10 z-0 rounded-full bg-blue-400 opacity-40 blur-2xl">
                                    </div>
                                </div>
                                ...
                                <div
                                     class="absolute bottom-0 left-0 right-0 z-20 bg-gradient-to-t from-white via-blue-50/80 to-transparent p-10 text-center">
                                    <h2
                                        class="text-shadow-2xs text-xl font-semibold uppercase tracking-wide text-blue-800">
                                        {{ strtoupper($member->heading) }}
                                    </h2>
                                    <p class="text-sm text-blue-600">{{ $member->sub_heading ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
