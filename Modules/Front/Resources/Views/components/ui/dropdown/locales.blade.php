...
<div class="relative" x-data="{ open: false }">
    <button class="inline-flex items-center gap-1 px-1.5 py-2" type="button" x-on:click="open = !open"
    ...
    <div class="absolute right-0 top-8 z-100 mt-2 w-48 overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-lg dark:border-zinc-700 dark:bg-zinc-800"
