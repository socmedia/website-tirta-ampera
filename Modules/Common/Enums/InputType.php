...
enum InputType: string
{
    ...
    /**
     * Get a human-readable label for each input type.
     *
     * @return string
     */
    ...
    /**
     * Define default field configuration for each input type
    ...
    /**
     * Checks if this input type is a standard HTML input element.
     *
     * @return bool
     */
    ...
    /**
     * Checks if this input type is related to media.
     *
     * @return bool
     */
    ...
    /**
     * Returns a list of all input type values (for selection lists).
     *
     * @return array<string>
     */
