    ...
    <div
        ...
        <div>
            ...
            <p class="text-sm text-gray-600 dark:text-neutral-400">
                Manage static pages, edit and more.
            </p>
        </div>
        @can('create-page')
            <a class="btn solid-primary whitespace-nowrap" href="{{ route('panel.web.page.create') }}" wire:navigate>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
            ...
            <div class="space-y-6 md:col-span-8 xl:col-span-6">
                <div class="card">
                                        ...
                                        <div class="flex gap-2">
                                            @can('update-page')
                                                <x-panel::ui.dropdown.alpine class="btn soft-secondary grid size-8 place-items-center p-0 dark:text-neutral-400"
                                                    ...
                                                    <x-panel::ui.dropdown.item href="{{ route('panel.web.page.edit', $content->id) }}"
                                                                               wire:navigate>
                    ...
                    @else
                        <x-panel::ui.table.empty title="There is no static page yet."
                                                 @can('create-page')
                                href="{{ route('panel.web.page.create') }}"
                            @endcan
                                                 icon="bx-file" wire:navigate
                                                 description="No static pages have been created yet. Start by adding a new static page to your site."
                                                 data="Static Page" />
                    @endif
                </div>
            </div>
