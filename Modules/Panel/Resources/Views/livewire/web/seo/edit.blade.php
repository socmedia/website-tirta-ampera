        ...
        <div class="grid max-w-screen-lg grid-cols-12 gap-4 md:gap-8">
            ...
            <div class="col-span-12 md:col-span-4">
                ...
                <p class="text-sm text-gray-600 dark:text-neutral-400">
                    Define the page, key, and input type for this SEO entry.
                </p>
            </div>
                ...
                <fieldset class="grid gap-2 sm:grid-cols-12 sm:gap-6">
                    ...
                    <div class="sm:col-span-4">
                        <x-panel::ui.forms.input id="form.key" type="text" label="Key" wire:model.lazy="form.key"
                                                 placeholder="e.g. seo_title, seo_description" />
                    </div>
                    <div class="sm:col-span-4">
            ...
            {{-- SEO VALUE --}}
            <div class="col-span-12 md:col-span-4">
                <h2 class="text-xl font-bold text-gray-800 dark:text-neutral-200">SEO Value</h2>
                <p class="text-sm text-gray-600 dark:text-neutral-400">
                    Enter the value for this SEO entry. The input adapts to the selected type.
                </p>
            </div>
            <div class="col-span-12 md:col-span-8">
                <div class="col-span-12 md:col-span-8">
                    <fieldset class="grid gap-2 sm:grid-cols-12 sm:gap-6">
                        ...
                        <div class="sm:col-span-6">
                            <x-panel::ui.forms.input id="form.name" label="SEO Name" wire:model.lazy="form.name"
    ...
    <div class="mt-10 max-w-screen-lg border-t border-gray-200 pt-10 dark:border-gray-700" x-data="{ show: false }">
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-6">
            <div class="lg:col-span-5">
                <h2 class="text-lg font-semibold text-red-600 dark:text-red-400">Delete SEO</h2>
                <p class="text-sm text-gray-600 dark:text-neutral-400">
                    Permanently delete this SEO entry and all its associated data.
                </p>
            </div>
        ...
        <x-panel::ui.modal title="Delete SEO">
            <form class="space-y-6 p-6" wire:submit="deleteContent">
                <div>
                    ...
                    <p class="my-2 text-sm text-gray-600 dark:text-neutral-400">
                        This will permanently delete this SEO entry and all its data. This action cannot be undone.
                    </p>
                    <small class="italic text-gray-500">Confirm: {{ $content->key }}</small>
                </div>

                <x-panel::ui.forms.input type="text" label="SEO key" placeholder="Enter SEO key to confirm"
