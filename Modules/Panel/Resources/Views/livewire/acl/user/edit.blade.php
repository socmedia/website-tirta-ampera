    ...
    <form wire:submit.prevent="handleSubmit">
        <div class="grid max-w-screen-lg grid-cols-12 gap-4 md:gap-8">
            ...
            <div class="col-span-12 md:col-span-4">
                <h2 class="text-xl font-bold text-gray-800 dark:text-neutral-200">User</h2>
            ...
            <div class="col-span-12 md:col-span-8">
                <fieldset class="grid gap-2 sm:grid-cols-12 sm:gap-6" wire:loading.class="skeleton"
                    ...
                    <div class="col-span-12">
                        ...
                        <x-panel::utils.tagify-tag :whitelist="$roles" wire:model="form.roles" :value="json_encode($form['roles'])"
                                                   placeholder="Add roles to user..." />
                    </div>
