...
class UpdateUserRequest extends FormRequest
{
    ...
    /**
     * User ID for the update scenario.
     *
     * @var string|null
     */
    ...
    /**
     * Constructor for injecting form data and user ID.
     *
     * @param array<string, mixed> $form
     * @param string|null $userId
     */
    public function __construct(array $form = [], string|null $userId = null)
    {
        parent::__construct();
    ...
    public function rules(): array
    {
        ...
        $userId = $this->userId ?? $this->input('user');
