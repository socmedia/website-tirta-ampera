...
{
    /**
     * Optional custom form input data.
     *
    ...
    /**
     * Constructor for optional manual form injection.
     *
    ...
    public function rules(): array
    {
        ...
        return [
            'form.name' => 'required|min:3|unique:permissions,name,NULL,id,guard_name,' . $guard,
