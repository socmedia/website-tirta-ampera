...
use Carbon\Carbon;
use Modules\Common\Models\CollaborationRequest;
...
class Collaboration extends Component
{
    ...
    /**
     * Update the collaboration and unseen counts based on the current date range.
     */
    ...
    {
        return view('panel::livewire.dashboard.widget.collaboration', [
