...
use Carbon\Carbon;
use Modules\Common\Models\CareerApplicant;
...
class Applicant extends Component
{
    ...
    /**
     * Update the applicant and unseen counts based on the current date range.
     */
    protected function updateCounts()
    {
        return CareerApplicant::query()
            ->status('pending')
    ...
    {
        return view('panel::livewire.dashboard.widget.applicant', [
