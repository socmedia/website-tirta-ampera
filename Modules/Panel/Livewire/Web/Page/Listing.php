...
class Listing extends Component
{
    ...
    /**
     * The selected tab filter (static page)
     *
     * @var string|null
     */
    ...
    /**
     * The list of tabs filter (static pages), each with nested sections
     *
     * @var array
     */
    public array $tabs = [];
    ...
    public function handleTabsAndSections()
    {
        ...
        // Tabs are static pages, each with nested sections
    ...
    {
        return view('panel::livewire.web.page.listing', [
