...
class Edit extends Component
{
    ...
    /**
     * The confirmation key for deleting SEO content.
     *
     * @var string|null
     */
    ...
    /**
     * Initialize component data for editing.
     *
     * @param Content $content
     * @return void
     */
    protected function initialize($content)
    {
        if ($content) {
            ...
            $this->form['type'] = $content->type ?? ContentType::SEO->value;
    ...
    /**
     * Handle the update of an existing SEO content.
     *
     * @return void
     */
    public function handleSubmit()
    {
        ...
        try {
            ...
            $this->notifySuccess('SEO updated successfully.');
        } catch (\Exception $e) {
            info($e);
            $this->notifyError($e);
        }
    ...
    /**
     * Delete the current SEO content.
     *
     * @return void
     */
    public function deleteContent()
    {
        try {
            if (!$this->content) {
                throw new Exception('No SEO content to delete.');
            }
            ...
            if (
                ...
                throw new Exception('The confirmation key does not match the SEO key.');
            }

            $this->contentService->delete($this->content->id);
            $this->notifySuccess('SEO deleted successfully.');
            // Optionally, redirect or emit event to parent
            return $this->redirect(route('panel.web.seo.index'), true);
        } catch (\Exception $e) {
            $this->notifyError($e);
        }
    }
    ...
    protected function prepareData(): array
    {
        ...
        $data['type'] = $data['type'] ?: ContentType::SEO->value;
    ...
    {
        return view('panel::livewire.web.seo.edit', [
