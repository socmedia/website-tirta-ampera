...
return new class extends Migration
{
    ...
    public function up()
    {
        // Create the 'customer_oauth_auth_codes' table to store authorization codes for customers
        Schema::create('customer_oauth_auth_codes', function (Blueprint $table) {
            $table->string('id', 100)->primary(); // Unique identifier for the auth code
            $table->char('customer_id', 8)->index(); // Customer ID associated with the auth code
        ...
        // Create the 'customer_oauth_access_tokens' table to store access tokens for customers
        Schema::create('customer_oauth_access_tokens', function (Blueprint $table) {
            $table->string('id', 100)->primary(); // Unique identifier for the access token
            $table->char('customer_id', 8)->nullable()->index(); // Customer ID associated with the access token
        ...
        // Create the 'customer_oauth_refresh_tokens' table to store refresh tokens for customers
        Schema::create('customer_oauth_refresh_tokens', function (Blueprint $table) {
        ...
        // Create the 'customer_oauth_clients' table to store client information for customers
        Schema::create('customer_oauth_clients', function (Blueprint $table) {
            $table->bigIncrements('id'); // Unique identifier for the client
            $table->char('customer_id', 8)->nullable()->index(); // Customer ID associated with the client
        ...
        // Create the 'customer_oauth_personal_access_clients' table to store personal access client information
        Schema::create('customer_oauth_personal_access_clients', function (Blueprint $table) {
    ...
    {
        // Drop the 'customer_oauth_auth_codes' table
        Schema::dropIfExists('customer_oauth_auth_codes');

        // Drop the 'customer_oauth_access_tokens' table
        Schema::dropIfExists('customer_oauth_access_tokens');

        // Drop the 'customer_oauth_refresh_tokens' table
        Schema::dropIfExists('customer_oauth_refresh_tokens');

        // Drop the 'customer_oauth_clients' table
        Schema::dropIfExists('customer_oauth_clients');

        // Drop the 'customer_oauth_personal_access_clients' table
        Schema::dropIfExists('customer_oauth_personal_access_clients');
    }
};
