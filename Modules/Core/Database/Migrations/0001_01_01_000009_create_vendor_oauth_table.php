...
return new class extends Migration
{
    ...
    public function up()
    {
        // Create the 'vendor_oauth_auth_codes' table to store authorization codes for vendors
        Schema::create('vendor_oauth_auth_codes', function (Blueprint $table) {
            $table->string('id', 100)->primary(); // Unique identifier for the auth code
            $table->char('vendor_id', 8)->index(); // Vendor ID associated with the auth code
        ...
        // Create the 'vendor_oauth_access_tokens' table to store access tokens for vendors
        Schema::create('vendor_oauth_access_tokens', function (Blueprint $table) {
            $table->string('id', 100)->primary(); // Unique identifier for the access token
            $table->char('vendor_id', 8)->nullable()->index(); // Vendor ID associated with the access token
        ...
        // Create the 'vendor_oauth_refresh_tokens' table to store refresh tokens for vendors
        Schema::create('vendor_oauth_refresh_tokens', function (Blueprint $table) {
        ...
        // Create the 'vendor_oauth_clients' table to store client information for vendors
        Schema::create('vendor_oauth_clients', function (Blueprint $table) {
            $table->bigIncrements('id'); // Unique identifier for the client
            $table->char('vendor_id', 8)->nullable()->index(); // Vendor ID associated with the client
        ...
        // Create the 'vendor_oauth_personal_access_clients' table to store personal access client information
        Schema::create('vendor_oauth_personal_access_clients', function (Blueprint $table) {
    ...
    {
        // Drop the 'vendor_oauth_auth_codes' table
        Schema::dropIfExists('vendor_oauth_auth_codes');

        // Drop the 'vendor_oauth_access_tokens' table
        Schema::dropIfExists('vendor_oauth_access_tokens');

        // Drop the 'vendor_oauth_refresh_tokens' table
        Schema::dropIfExists('vendor_oauth_refresh_tokens');

        // Drop the 'vendor_oauth_clients' table
        Schema::dropIfExists('vendor_oauth_clients');

        // Drop the 'vendor_oauth_personal_access_clients' table
        Schema::dropIfExists('vendor_oauth_personal_access_clients');
    }
};
