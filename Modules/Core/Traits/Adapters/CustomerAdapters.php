...
use Modules\Core\App\Enums\CustomerStatus;
use Illuminate\Support\Facades\Storage;
use Modules\Core\App\Enums\UserStatus;

trait CustomerAdapters
{
    /**
     ...
     *
     * @return string The URL of the customer's avatar or a generated default avatar
     */
    ...
    /**
     * Get a badge showing the current customer status using the CustomerStatus enum.
     *
     * @return string HTML badge showing customer status
     */
    ...
    /**
     * Get the customer's status as a UserStatus enum instance.
     *
     * @return UserStatus
     */
    ...
    /**
     * Get rendered badges for all customer roles.
     *
     * @return string HTML badges for customer roles
     */
    ...
    /**
     * Get the customer's full name or fallback to email.
     *
     * @return string
     */
    ...
    /**
     * Get the total number of roles assigned to the customer.
     *
     * @return int
     */
    ...
    /**
     * Get badges showing all customer roles.
     *
    ...
    /**
     * Get the customer's last login date in a formatted string.
     *
     * @return string|null
     */
    ...
    /**
     * Get a badge indicating if the customer has roles.
     *
