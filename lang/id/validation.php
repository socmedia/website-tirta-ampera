...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'Kolom :attribute harus antara karakter :min dan :max.',
    ],
    ...
    'contains' => 'Itu :kolom atribut tidak memiliki nilai yang diperlukan.',
    'current_password' => 'Kata sandi salah.',
    'date' => 'Kolom atribut harus berupa tanggal yang valid.',
    'date_equals' => 'Kolom atribut harus berupa tanggal yang sama dengan :date.',
    'date_format' => 'Kolom atribut harus sesuai dengan format :format.',
    'decimal' => 'Kolom atribut harus memiliki tempat desimal :decimal.',
    'declined' => 'Kolom atribut harus ditolak.',
    'declined_if' => 'Kolom atribut harus ditolak jika :other adalah :value.',
    'different' => 'Kolom atribut dan :other harus berbeda.',
    'digits' => 'Kolom atribut harus berupa :digits digit.',
    'digits_between' => 'Kolom atribut harus berada di antara digit :min dan :max.',
    ...
    'filled' => 'Kolom :attribute harus memiliki value.',
    'gt' => [
        'array' => 'Kolom :attribute harus memiliki lebih dari item :value.',
        'file' => 'Kolom :attribute harus lebih besar dari kilobyte :value.',
        'numeric' => 'Kolom :attribute harus lebih besar dari :value.',
        'string' => 'Kolom :attribute harus lebih besar dari karakter :value.',
    ],
    'gte' => [
        'array' => 'Kolom :attribute harus memiliki item :value atau lebih.',
        'file' => 'Kolom :attribute harus lebih besar dari atau sama dengan kilobyte :value.',
        'numeric' => 'Kolom :attribute harus lebih besar dari atau sama dengan :value.',
        'string' => 'Kolom :attribute harus lebih besar dari atau sama dengan karakter :value.',
    ],
    'hex_color' => 'Kolom :attribute harus berupa warna heksadesimal yang valid.',
    'image' => 'Kolom :attribute harus berupa gambar.',
    'in' => 'Atribut yang dipilih tidak valid.',
    'in_array' => 'Kolom :atribut harus ada di :other.',
    'in_array_keys' => 'Kolom :atribut harus berisi setidaknya satu kunci berikut: :values.',
    'integer' => 'Kolom :atribut harus berupa integer.',
    'ip' => 'Kolom :atribut harus berupa alamat IP yang valid.',
    'ipv4' => 'Kolom :atribut harus berupa alamat IPv4 yang valid.',
    'ipv6' => 'Kolom :atribut harus berupa alamat IPv6 yang valid.',
    'json' => 'Kolom :atribut harus berupa string JSON yang valid.',
    'list' => 'Kolom :atribut harus berupa daftar.',
    'lowercase' => 'Kolom :atribut harus berupa huruf kecil.',
    'lt' => [
        'array' => 'Kolom :atribut harus memiliki kurang dari :nilai item.',
        'file' => 'Kolom :attribute harus kurang dari :nilai kilobyte.',
        'numeric' => 'Kolom :attribute harus kurang dari :nilai.',
        'string' => 'Kolom :attribute harus kurang dari :nilai karakter.',
