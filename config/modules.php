...
return [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            // Traits/
            'scopes' => ['path' => 'Traits/Scopes', 'generate' => true],
            ...
            'component-view' => ['path' => 'Resources/views/vomponents', 'generate' => false],
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'ssh'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'SOC Software House'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'socsoftwarehouse@gmail.com'),
        ],
